...
<div class="row">
  <div class="col-md-12">
      <div class="panel panel-success">
        <div class="panel-heading">Sell Product</div>
  ...
  <h5 style="margin-top:40px;">Order Details</h5><hr style="margin-top: 10px;">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control" name="date" id="date" value="<?php echo date("Y-m-d g:i a"); ?>" required readonly="readonly">
    </div>
  </div>
