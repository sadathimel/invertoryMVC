...
if($_POST) {
      ...
      $result = "SELECT * FROM purchases WHERE purchase_id = '$purchase_id'";
...
<form class="form-inline" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
  <div class="form-group">
    <input type="text" class="form-control" id="purchase_id" name="order_id" placeholder="Enter an purchase id">
  </div>
